...
class Leaderboard extends React.Component {
  ...
  getData() {
    /* Here we can implement data fetching from DB*/
    let data = {
      success: true,
      leaders: [
        { id: 1, name: "User 3", score: 500 },
        { id: 3, name: "User 1", score: 275 },
        { id: 2, name: "User 4", score: 220 },
        { id: 4, name: "user 2", score: 200 },
        { id: 5, name: "user 5", score: 175 },
        { id: 6, name: "user 8", score: 173 },
        { id: 7, name: "user 7", score: 114 },
        { id: 8, name: "user 10", score: 111 },
        { id: 9, name: "user 9", score: 91 },
        { id: 10, name: "user 6", score: 25 },
      ],
      maxScore: 500,
    };
    this.setState({
